...
(function($) {
  ...
  $(window).on('scroll', function () {
    if ($(this).scrollTop() > 300) {
      $(".header-section.text-white .brand-logo > a > img").attr("src", "assets/images/logo_1.png");
    } else {
      $(".header-section.text-white .brand-logo > a > img").attr("src", "assets/images/logo_2.png");
    }
  });
  // sticky header - end
  // --------------------------------------------------
